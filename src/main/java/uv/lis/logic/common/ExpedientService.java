...
public class ExpedientService {
    ...
    public boolean uploadAndRegisterDocument(String enrollment, String documentName, String documentType, File sourceFile,int idStudent) throws OperationException {
